(() => {
  ...
  const CATALOGO = [
    ...
    { categoria: 'Salgados e Bolos', nome: 'Hamburgão', preco: 8, img: 'img/hamburgao.jpg' },
    { categoria: 'Salgados e Bolos', nome: 'Coxinha de Frango Catupiry', preco: 12, img: 'img/coxinha-catupiry.jpg' },
    { categoria: 'Salgados e Bolos', nome: 'Esfirra de Carne', preco: 8, img: 'img/esfirra-carne.jpg' },
    { categoria: 'Salgados e Bolos', nome: 'Esfirra de Frango', preco: 8, img: 'img/esfirra-frango.jpg' },
    { categoria: 'Salgados e Bolos', nome: 'Bolo Caseiro Fatia', preco: 7, img: 'img/bolo-caseiro.jpg' },
    { categoria: 'Salgados e Bolos', nome: 'Bolo Gelado Trufado', preco: 10, img: 'img/bolo-trufado.jpg' },
    { categoria: 'Bebidas', nome: 'Refrigerante Lata 350mL', preco: 7, img: 'img/refrigerante.jpg' },
    { categoria: 'Bebidas', nome: 'Suco Lata 290mL', preco: 7, img: 'img/suco-lata.jpg' },
    { categoria: 'Bebidas', nome: 'Água Mineral Com Gás 510mL', preco: 5, img: 'img/agua-gas.jpg' },
    { categoria: 'Bebidas', nome: 'Água Mineral Sem Gás 510mL', preco: 4, img: 'img/agua.jpg' },
    { categoria: 'Bebidas', nome: 'Refrigerante Mini 200mL', preco: 4, img: 'img/refrigerante-mini.jpg' },
    { categoria: 'Cafeteria', nome: 'Café Expresso', preco: 5, img: 'img/cafe-expresso.jpg' },
    { categoria: 'Cafeteria', nome: 'Café Com Leite', preco: 6, img: 'img/cafe-leite.jpg' },
    { categoria: 'Cafeteria', nome: 'Cappuccino', preco: 8, img: 'img/cappuccino.jpg' },
    { categoria: 'Cafeteria', nome: 'Chocolate Quente', preco: 7, img: 'img/chocolate-quente.jpg' },
    { categoria: 'Sucos e Vitaminas', nome: 'Vitaminas de Fruta MIX', preco: 5, img: 'img/vitamina.jpg' },
    { categoria: 'Sucos e Vitaminas', nome: 'Suco', preco: 5, img: 'img/sucos-frutas.jpg' },
    { categoria: 'Combos do Café', nome: 'Pão de Queijo + Café Expresso', preco: 10, img: 'img/pao-cafe.jpg' },
    { categoria: 'Combos do Café', nome: 'Pão de Queijo + Café com Leite', preco: 11, img: 'img/pao-leite.jpg' },
    { categoria: 'Combos do Café', nome: 'Pão de Queijo + Cappuccino', preco: 13, img: 'img/pao-cappuccino.jpg' },
    { categoria: 'Combos do Café', nome: 'Pão de Queijo + Chocolate Quente', preco: 12, img: 'img/pao-chocolate.jpg' },
    { categoria: 'Outros', nome: 'Chiclete', preco: 6, img: 'img/chiclete.jpg' },
    { categoria: 'Outros', nome: 'Bala', preco: 2.5, img: 'img/bala.jpg' },
    { categoria: 'Outros', nome: 'Outro', preco: null, img: 'img/outro.jpg', precoPersonalizado: true }
  ];
